  ...
  return (
    <nav className="navbar navbar-expand-lg top-bar" data-bs-theme="dark">
      <div className="container-fluid">
        ...
        <button className="btn btn-outline-secondary ms-2 me-2 d-flex justify-content-center align-items-center"  style={{height:"32px",width:"32px",backgroundColor:"#010409",padding:"0"}} type="submit">
